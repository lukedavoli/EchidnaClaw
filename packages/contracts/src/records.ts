...
export const taskSchema = createRecordSchema('task', taskIdSchema, {
  ...
  cancellationRequestedAt: isoDateTimeSchema.nullable().default(null),
  cancellationReason: z.string().trim().nullable().default(null),
  lastCheckpointAt: isoDateTimeSchema.nullable().default(null),
...
export const headTurnSchema = createRecordSchema('head_turn', headTurnIdSchema, {
  ...
  memorySearchId: nonEmptyStringSchema.nullable().default(null),
  memoryUpdateIds: z.array(nonEmptyStringSchema).default([]),
...
export const handsRunSchema = createRecordSchema('hands_run', handsRunIdSchema, {
  ...
  workerInstanceId: nonEmptyStringSchema,
  cancellationRequestedAt: isoDateTimeSchema.nullable().default(null),
  cancelledAt: isoDateTimeSchema.nullable().default(null),
  resultCode: nonEmptyStringSchema.nullable().default(null),
  failureCode: nonEmptyStringSchema.nullable().default(null),
