...
export const auditEventIdSchema = createIdentifierSchema('aud');
export const credentialCaptureIdSchema = createIdentifierSchema('ccp');
...
export const telegramProvisioningSessionIdSchema = createIdentifierSchema('tps');
...
export type CredentialCaptureId = z.infer<typeof credentialCaptureIdSchema>;
...
export type TelegramProvisioningSessionId = z.infer<typeof telegramProvisioningSessionIdSchema>;
